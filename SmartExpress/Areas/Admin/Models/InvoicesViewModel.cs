...
namespace SmartExpress.Admin.Models
{
    public class InvoicesViewModel : BaseViewModel
    {
        ...
        public InvoicesTreeViewModel TreeViewModel { get; set; }

    }

    public class InvoicesTreeViewModel : TreeListVeiwModelBase
    {
        public List<InvoiceTreeItem> TreeItems { get; set; }
